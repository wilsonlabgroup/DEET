...
All processed DEGs, metadata, and enriched pathways in formats compatible with this package as well as other methods such as gene set enrichment analysis are stored here: http://www.wilsonlab.org/public/DEET_data/
...
One option is to download the *gmt files diretly from our ftp. `http://www.wilsonlab.org/public/DEET_data/DEET_DE.gmt` Is directly compatible with these tools.
